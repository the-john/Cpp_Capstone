...
/*
// Create a unique pointer for each frame image
void Face::uniquePointer(cv::Mat& _frame) {
    std::unique_ptr<cv::Mat> imagePtr(new cv::Mat);                                                         // create a unique pointer on the stack
    *imagePtr = _frame;                                                                                     // assign the pointer to the image frame
}
*/
